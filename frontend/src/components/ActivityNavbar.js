...
import AllActivityFilter from "./AllActivityFilter";
import "../styles/ActivityNavbar.css"

const ActivityNavbar = ({lg, setFilters, filters}) => {
  ...
  return (
    <div className="activity-navbar">
        <div className="activity-navbar-div" style={{ backgroundImage: lg }}>
    {/* Left: Logo */}
    ...
    <div className="activity-header-log">
                <AllActivityFilter filters={filters} setFilters={setFilters}/>
