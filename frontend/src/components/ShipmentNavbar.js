...
const ShipmentNavbar = ({lg, options, setOptions}) => {
  ...
  return (
    <div className="about-navbar-div">
      <img className="about-logo" src={logo} alt="DeMa" />

      <div className="navbar-center">
   
    <div className="shipping-subHeadings">
              <div className={`shipping-subHeadings-items ${options === "Trade Info" ? "active" : ""}`} onClick={()=>{setOptions("Trade Info")}}>Trade Info</div>
              <div className={`shipping-subHeadings-items ${options === "Transit Path" ? "active" : ""}`} onClick={()=>{setOptions("Transit Path")}}>Transit Path</div>
              <div className={`shipping-subHeadings-items ${options === "Events" ? "active" : ""}`} onClick={()=>{setOptions("Events")}}>Events</div>
          </div>
